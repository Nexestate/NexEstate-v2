...
export const ADMIN_NAV: NavSection[] = [
  {
    ...
    items: [
      ...
      { to: '/admin/shares', label: 'שיתופי נכסים', icon: Home },
      { to: '/admin/support', label: 'פניות תמיכה', icon: Bell },
      { to: '/admin/import', label: 'ייבוא עסקאות', icon: BarChart3 },
    ],
  },
  {
    title: 'סטטוס מהיר',
    items: [
      { to: '/admin/pending', label: 'ממתינים לאישור', icon: ClipboardList },
      { to: '/admin/approved', label: 'מאושרים היום', icon: Shield },
      { to: '/admin/rejected', label: 'דחויים היום', icon: Target },
    ],
  },
  {
    title: 'חשבון',

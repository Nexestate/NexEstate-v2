...
export const BROKER_NAV: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/broker/units', label: 'יחידות', icon: Layers, addNew: 'unit' },
      { to: '/broker/tenants', label: 'שוכרים', icon: Users, addNew: 'tenant' },
      { to: '/broker/leases', label: 'חוזים', icon: FileText, addNew: 'lease' },
      { to: '/broker/payments', label: 'תשלומים', icon: CreditCard },
